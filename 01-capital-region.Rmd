...
```{r fig-prices-runits-parish,  fig.height=10, fig.width=10, fig.cap = "Median 2020-adjusted house prices in the ordinary free trade by grid cells of 100m x 100m"}
...
```{r ternary-pop-year, fig.height=10, fig.width=10, fig.cap = "ternary plot by year"}
...
```{r ternary-pop-parish, fig.height=20, fig.width=10, fig.cap = "Ternary plots by parish"}
...
```{r fig-parish-tern-pop-price-all, fig.cap = "Median housing prices and popupation distribution by parish (all data)"}
...
```{r fig-parish-tern-pop-price-year, fig.height=10, fig.width=10, fig.cap = "Median housing prices and popupation distribution by parish and year"}
...
```{r tern-map, fig.height=20, fig.width=20, fig.cap="Population distribution"}
...
```{r tern-map-2020, fig.height=10, fig.width=10, fig.cap="Population distribution in 2020"}
