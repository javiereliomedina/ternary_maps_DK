...
```{r fig-cap-reg-tern-pop-year, fig.height=10, fig.width=10, fig.cap = "ternary plot by year"}
...
```{r fig-cap-reg-tern-map-2020, fig.height=10, fig.width=10, fig.cap="Population distribution in 2020"}
